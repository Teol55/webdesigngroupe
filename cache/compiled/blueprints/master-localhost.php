...
return [
    ...
    'checksum' => '8daa8a114f90e6307d32a1c022d8daa0',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/mailchimp' => [
                'file' => 'user/plugins/mailchimp/blueprints.yaml',
                'modified' => 1554836586
            ],
    ...
    'data' => [
        'items' => [
            ...
            'plugins.mailchimp.enabled' => [
                ...
                'name' => 'plugins.mailchimp.enabled',
                'validation' => 'strict'
            ],
            'plugins.mailchimp.api_key' => [
                'type' => 'password',
                'label' => 'MAILCHIMP_SETTINGS.API_KEY.LABEL',
                'name' => 'plugins.mailchimp.api_key',
                'validation' => 'strict'
            ],
            'plugins.mailchimp.language_detection_mode' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.mailchimp.language_detection_mode',
                'validation' => 'strict'
            ],
            'plugins.mailchimp.default_language' => [
                'type' => 'select',
                'size' => 'long',
                'label' => 'MAILCHIMP_SETTINGS.DEFAULT_LANGUAGE.LABEL',
                'default' => 'en',
                'data-options@' => '\\Grav\\Plugin\\MailChimpPlugin::supportedLanguages',
                'name' => 'plugins.mailchimp.default_language',
                'validation' => 'strict'
            ],
            'plugins.mailchimp.default_status' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.mailchimp.default_status',
                'validation' => 'strict'
            ],
            'plugins.mailchimp.delete_first' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.mailchimp.delete_first',
                'validation' => 'strict'
            ],
            'plugins.markdown-notices' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'mailchimp' => [
                    ...
                    'api_key' => 'plugins.mailchimp.api_key',
                    'language_detection_mode' => 'plugins.mailchimp.language_detection_mode',
                    'default_language' => 'plugins.mailchimp.default_language',
                    'default_status' => 'plugins.mailchimp.default_status',
                    'delete_first' => 'plugins.mailchimp.delete_first'
                ],
                'markdown-notices' => [
